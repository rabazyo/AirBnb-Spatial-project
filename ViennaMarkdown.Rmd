...
vienna_weekdays <- read.csv("~/Airbnb data/vienna_weekdays.csv")
vienna_weekends <- read.csv("~/Airbnb data/vienna_weekends.csv")
vienna <- rbind(vienna_weekdays, vienna_weekends)
str(vienna)
```
