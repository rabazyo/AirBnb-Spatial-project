...
berlin_weekdays <- read.csv("~/GitHub/AirBnb-Spatial-project/data sets/berlin_weekdays.csv")
berlin_weekends <- read.csv("~/GitHub/AirBnb-Spatial-project/data sets/berlin_weekends.csv")
berlin <- rbind(berlin_weekdays, berlin_weekends)
str(berlin)
```
