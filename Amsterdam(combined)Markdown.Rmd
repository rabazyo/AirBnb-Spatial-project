---
title: "AmsterdamMarkdown(combined)"
...
amsterdam_weekdays <- read.csv("~/GitHub/AirBnb-Spatial-project/data sets/amsterdam_weekdays.csv")
amsterdam_weekends <- read.csv("~/GitHub/AirBnb-Spatial-project/data sets/amsterdam_weekends.csv")
...
form_pre1 <- log(bar_sf$realSum) ~   bar_sf$host_is_superhost + bar_sf$attr_index + bar_sf$person_capacity + bar_sf$dist + bar_sf$metro_dist
